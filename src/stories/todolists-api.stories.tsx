...
import { todolistsAPI } from "../features/todolistsLists/api/todolistsApi";
import { tasksAPI } from "features/todolistsLists/api/tasksApi";
...
export const GetTodolists = () => {
   ...
   useEffect(() => {
      todolistsAPI.readTodolists().then((res) => {
         setState(res.data);
      });
   }, []);
...
export const CreateTodolist = () => {
   const [state, setState] = useState<any>(null);
   useEffect(() => {
      todolistsAPI.createTodolists("NEW_TODOLIST").then((res) => {
         setState(res.data);
      });
   }, []);
...
export const UpdateTodolistTitle = () => {
   ...
   useEffect(() => {
      ...
      todolistsAPI.updateTodolists("Second2", todolistID).then((res) => {
         setState(res.data);
      });
   }, []);
...
export const GetTask = () => {
   ...
   const createTask = () => {
      tasksAPI.readTask(todoID).then((res) => {
         console.log(res);
         setState(res.data);
      });
   };
